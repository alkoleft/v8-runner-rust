...
Если вам нужна точная публичная поверхность, используйте [CAPABILITIES.md](CAPABILITIES.md). Если нужен полный справочник по `application.yaml`, используйте [CONFIGURATION.md](CONFIGURATION.md). Если нужна внутренняя карта модулей, используйте [../ARCHITECTURE.md](../ARCHITECTURE.md).
