...
- Пример для конфигурации, не присоединенной к текущему хранилищу: DESIGNER `/F` "D:\V8\Cfgs8\ИБ8" `/ConfigurationRepositoryF` "D:\V8\Cfgs8" `/ConfigurationRepositoryN` "Администратор" `/ConfigurationRepositoryP` xxx `/ConfigurationRepositoryClearLocalCache`
- Пример для конфигурации, присоединенной к хранилищу конфигурации: DESIGNER `/F` "D:\V8\Cfgs8\ИБ8" `/ConfigurationRepositoryClearLocalCache`
